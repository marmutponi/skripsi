...
SELECT  
	...
	sum(IF(DAY(tanggal) = 30 && stock_opname = 0, awal, 0)) AS awal_30,
	sum(IF(DAY(tanggal) = 30 && stock_opname = 0, masuk, 0)) AS masuk_30,
	sum(IF(DAY(tanggal) = 30 && stock_opname = 0, keluar, 0)) AS keluar_30,
	sum(IF(DAY(tanggal) = 30 && stock_opname = 0, akhir, 0)) AS akhir_30,
	
	sum(IF(DAY(tanggal) = 31 && stock_opname = 0, awal, 0)) AS awal_31,
	sum(IF(DAY(tanggal) = 31 && stock_opname = 0, masuk, 0)) AS masuk_31,
	sum(IF(DAY(tanggal) = 31 && stock_opname = 0, keluar, 0)) AS keluar_31,
	sum(IF(DAY(tanggal) = 31 && stock_opname = 0, akhir, 0)) AS akhir_31,
