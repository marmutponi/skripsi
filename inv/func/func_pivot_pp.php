...
if ($bln == "2") {include '../func/tgl_pp/28.php';}
else if ($bln == "4" OR $bln == "6" OR $bln == "9" OR $bln == "11") {include '../func/tgl_pp/30.php';}
else include '../func/tgl_pp/31.php';
...
<thead>
	...
	<th colspan ="15">Plan Produksi Bulanan</th>
	...
	<th colspan ="15"><i>0'.$bln_3digit.'/PPB/PPIC/00/'.$bln_roma.'/'.substr($thn, -2).'/TMI 2</i></th>
