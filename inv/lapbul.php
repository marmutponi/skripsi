...
<table width="100%" class="head"><tr>
 <th class="head"><div data-role='header'><h3>Daftar Laporan Inventaris Triona Multi Industri</h3></div></th>
 <th class="head">
 <?php 
 ...
 <div id="content">
 <a href="wip_gojek/index.php"><button class='button'>WIP Components GOJEK</button></a>
 <a href="fg/index.php"><button class='button'>Finished Good</button></a>
 <?php
 ?>
 </div>
</div>
