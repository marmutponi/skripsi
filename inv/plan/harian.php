...
if (empty($_POST["tgl"])) {$_POST["tgl"] = $tanggalini;}
else $_POST["tgl"] = $_POST["tgl"];
...
<table width="100%" class="head"><tr>
 <th class="head"><div data-role='header'><h3>Modul Production Plan Harian</h3></div></th>
 <th class="head">
 <?php 
 if(isset($_SESSION['username'])) 
 {echo "
 ...
 <div id="content">
  ...
  {
	for ($t = 1; $t <= 28; $t++)
	{echo "<option value='$t'"; if($_POST["tgl"]== $t ) {echo "selected=\"selected\"";} echo "> $t </option>";}
  }
  else if ($_POST["bln"] == "4" OR $_POST["bln"] == "6" OR $_POST["bln"] == "9" OR $_POST["bln"] == "11")
  {
	for ($t = 1; $t <= 30; $t++)
	{echo "<option value='$t'"; if($_POST["tgl"]== $t ) {echo "selected=\"selected\"";} echo "> $t </option>";}
  }
 ...
 <?php include '../func/func_pivot_pph.php'; ?>
 </div>
</div>
</center>
</body>
