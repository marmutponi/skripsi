...
if (empty($_POST["mgg"])) {$_POST["mgg"] = "1";}
else $_POST["mgg"] = $_POST["mgg"];
...
<table width="100%" class="head"><tr>
 <th class="head"><div data-role='header'><h3>Modul Production Plan Mingguan</h3></div></th>
 <th class="head">
 <?php 
 if(isset($_SESSION['username'])) 
 {echo "
 ...
 <div id="content">
  <form action="mingguan.php" method="post">
  ...
  <tr>
  <td><select name="mgg">
  <option value="1"<?php if($_POST['mgg']=="1") echo "selected=\"selected\""; ?>>Pertama</option>
  <option value="2"<?php if($_POST['mgg']=="2") echo "selected=\"selected\""; ?>>Kedua</option>
  <option value="3"<?php if($_POST['mgg']=="3") echo "selected=\"selected\""; ?>>Ketiga</option>
  <option value="4"<?php if($_POST['mgg']=="4") echo "selected=\"selected\""; ?>>Keempat</option>
  <option value="5"<?php if($_POST['mgg']=="5") echo "selected=\"selected\""; ?>>Kelima</option>
  </select></td>
  <td><select name="bln">
 ...
 <?php include '../func/func_pivot_ppm.php'; ?>
 </div>
</div>
</center>
</body>
